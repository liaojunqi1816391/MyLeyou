...
public class GoodsServiceImpl implements GoodsService {
    ...
    @Override
    public void changeSaleableById(Long spuId, Boolean saleable) {
        this.spuMapper.changeSaleableById(spuId,saleable);
    }
    ...
    public List<Sku> querySkusBySkuIds(List<Long> ids) {
        return this.skuMapper.queryByIds(ids);
    }
...
//        System.out.println("send ok! id : " + id);
        // 发送消息
        try {
